  ...
  return (
    <div className="flex h-full w-full flex-col">
      <div className="px-30px py-20px relative flex w-full justify-center">
        ...
        <h2 className="text-24px m-0 font-bold">Checkout</h2>
      </div>

      <Scrollbar className="checkout-scrollbar flex-grow">
        <div className="px-30px pt-20px flex flex-col">
          <div className="mb-45px flex flex-col">
            <span className="text-18px mb-15px flex font-semibold text-gray-900">
              Contact Information
            </span>
            <PatternFormat
              format="+1 (###) ###-####"
            ...
            {error?.field === "phone_number" && (
              <p className="text-12px text-error pt-10px pl-15px font-semibold">
                {error.message}
              </p>
            )}
            <Input
